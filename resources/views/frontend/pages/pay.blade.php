                    ...
                    <div class="position-absolute translate-middle absolute_thanhtoan">
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                <input type="text" name="quantiti" class="form-control thanhtoan_quantiti">
                            </div>
                            <div class="col-lg-5">
                    ...
                    <div class="position-absolute translate-middle absolute_thanhtoan1">
                        <div class="row ">
                            <div class="col-lg-12">
                                ...
                                <input type="text" name="sothe" class="form-control thanhtoan_contact1">
                            </div>
                        </div>
                        <div class="row mt-2">
                            <div class="col-lg-12">
                                <label for="" class="label_thanhtoan">Họ tên chủ thẻ</label>
                                <input type="text" name="name" class="form-control thanhtoan_contact1">
                            </div>
                        </div>
